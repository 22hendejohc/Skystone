...
@Autonomous(name="Collection Zone - Move Build Plate - Red Side", group="Linear Opmode")
//@Disabled

public class Collection_Plate_Red extends Auto2_0 {
