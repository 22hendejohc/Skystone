...
@Autonomous(name="Build Zone - Move Build Plate - Blue Side", group="Linear Opmode")
//@Disabled

public class Build_Plate_Blue extends Auto2_0 {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (opModeIsActive()) {
            ...
            driveWithNoEncoders(1, 180, 1000);

            Thread.sleep(500);

            driveWithNoEncoders(1,90,2000);

            Thread.sleep(500);

            driveWithNoEncoders(1, 180, 700);

            Thread.sleep(500);

            driveWithNoEncoders(1, 270, 1000);
